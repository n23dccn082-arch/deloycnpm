...
### 🎯 Phạm vi phụ trách
Module thanh toán: tích hợp VNPay, QR code chuyển khoản, xử lý callback thanh toán.
...
- **QR chuyển khoản**: tạo QR code VietQR hiển thị cho user quét
...
5. *QR chuyển khoản được tạo như thế nào? Thông tin nào được mã hóa trong QR?*

---

## 👤 Thành Viên 5 — Giao Diện Người Dùng & Admin Dashboard (UI/UX & Admin)

### 🎯 Phạm vi phụ trách
Toàn bộ giao diện chung, layout, Admin dashboard và trải nghiệm người dùng.

...
import { CustomCheckbox, WrapperCountOrder, WrapperInfo, WrapperItemOrder, WrapperLeft, WrapperListOrder, WrapperRight, WrapperStyleHeader, WrapperTotal } from './style';
...
// StepComponent intentionally removed from cart UI; shipping handled on /payment
...
const OrderPage = () => {
  ...
  // Shipping calculation removed from cart display; shipping is applied at payment
  ...
  // Shipping options removed from cart page — handled on /payment
  return (
          ...
          <WrapperRight>
            <div style={{width: '100%'}}>
              ...
              <WrapperInfo>
                ...
                {/* Shipping shown on payment page; removed from cart */}
              </WrapperInfo>
              <WrapperTotal>
                <span>Tổng tiền</span>

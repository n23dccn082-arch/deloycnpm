        ...
        <Loading isLoading={isLoading}>
          ...
          >
            ...
            <Form.Item
              ...
              name="description"
            >
              <Input.TextArea value={stateProduct.description} onChange={handleOnchange} name="description" placeholder="Nhập mô tả sản phẩm..." rows={6} />
            </Form.Item>
            {/* Rating removed: ratings are derived from customer reviews */}
            <Form.Item
              label="Discount"
        ...
        <Loading isLoading={isLoadingUpdate || isLoadingUpdated}>
          ...
          >
            ...
            <Form.Item
              ...
              name="description"
            >
              <Input.TextArea value={stateProductDetails.description} onChange={handleOnchangeDetails} name="description" placeholder="Nhập mô tả sản phẩm..." rows={6} />
            </Form.Item>
            {/* Rating removed: ratings are derived from customer reviews */}
            <Form.Item
              label="Discount"
